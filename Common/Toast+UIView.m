...
- (void)makeToastActivity:(id)position {
    ...
    [activityContainer setBackgroundColor:[[UIColor grayColor] colorWithAlphaComponent:kOpacity]];
...
- (CGPoint)getPositionFor:(id)point toast:(UIView *)toast {
    ...
    if([point isKindOfClass:[NSString class]]) {
        ...
        if( [point caseInsensitiveCompare:@"top"] == NSOrderedSame ) {
            ...
            return CGPointMake(self.bounds.size.width/2, (self.bounds.size.height - (toast.frame.size.height / 2)) - kVerticalPadding-40);
...
- (UIView *)makeViewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    [wrapperView setBackgroundColor:[[UIColor grayColor] colorWithAlphaComponent:kOpacity]];
